...
static const mi_rs_layout_entry_t mi_rs_layout_entries[] = {
  ...
  MI_RS_OFFSET(mi_purge_all_report_t, arenas_reclaimed)
  MI_RS_OFFSET(mi_purge_all_report_t, arena_reclaim_bytes)
  MI_RS_OFFSET(mi_purge_all_report_t, arenas_kept)
  MI_RS_OFFSET(mi_purge_all_report_t, subprocs_pending)
  MI_RS_OFFSET(mi_purge_all_report_t, reclaimed)
  MI_RS_SIZEOF(mi_purge_flags_t)
  MI_RS_CONST(MI_PURGE_FORCE)
  MI_RS_CONST(MI_PURGE_RECLAIM)
...
#undef MI_STAT_COUNTER
  ...
  MI_RS_OPTION(mi_option_retain_feedback)
