/* GENERATED FILE -- DO NOT EDIT. Produced by rust/xtask from commit 4e18afa7 of the three public headers (mimalloc.h, mimalloc/profile.h, mimalloc/memory-events.h). Regenerate with: cargo run -p xtask -- amalgamate-h */
