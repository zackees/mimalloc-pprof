/* GENERATED FILE -- DO NOT EDIT. Produced by rust/xtask from commit 9c154e51 of the public headers (mimalloc.h, mimalloc/profile.h, mimalloc/memory-events.h, mimalloc/dhat.h). Regenerate with: cargo run -p xtask -- amalgamate-h */
