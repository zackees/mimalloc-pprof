    ...
    switch (op) {
      ...
      case 5: {  /* rezalloc -- the region beyond the old USABLE size must be zero */
        ...
        /* Measured against the old *usable* size, not the old requested size.
           ...
           An earlier version of this harness asserted from the requested size and the
           fuzzer promptly failed it. The fuzzer was right and the assertion was wrong;
           this is the property mimalloc actually provides. */
